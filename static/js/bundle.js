...
var _form_validator = require("./form_validator.es6");
...
$(document).ready(function () {
  var theCutestFormEver = new _form_validator2.default('myForm');
  theCutestFormEver.setChange();
});

},{"./form_validator.es6":12,"./serializeObject.es6":13,"jquery":1}],12:[function(require,module,exports){
'use strict';
  ...
  _createClass(FormValidator, [{
    ...
    value: function setChange() {
      ...
      for (var i = 0; i < this.form.elements.length; i++) {
        $(this.form.elements[i]).change(function (e) {
          _this.validate($(event.target));
        });
      }
    }
  }, {
    ...
    key: 'messageHandler',
    value: function messageHandler(input, msg, klass) {
      $(input.closest(".input-control")).append("<div class='" + klass + "'>" + msg + "</strong>");
    }
  }, {
    key: 'removeMessages',
    value: function removeMessages(input) {
...
},{"jquery":1,"sweetalert":10}],13:[function(require,module,exports){
"use strict";
